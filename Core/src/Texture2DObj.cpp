...
Texture2DObj::Texture2DObj(ProgramShader program_shader, VAOTexture2D& vao, Transform3D& transform)
...
void Texture2DObj::render() const
{
    ...
    m_program_shader.setTransform(Transformer::Transform(m_transform));
